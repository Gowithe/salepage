  ...
  return (
    <>
      <div className="topbar">
        <div className="container brand">Checkout</div>
      </div>
      ...
      <main className="section">
        <div className="container checkout-wrap">
          <form className="checkout-card" onSubmit={submit}>
            ...
            {error && (
              <div className="notice payment-status payment-error">
                {error}
              </div>
            )}
            ...
            <button className="btn" disabled={loading}>
              {loading
                ...
                : 'ดำเนินการชำระเงิน 390 บาท'}
            </button>
          </form>

          <aside className="checkout-card sticky">
            <h3>Passive Income Starter Set</h3>

            {[
              'E-book',
              'คอร์ส Passive Income',
              'คอร์สภาษีหุ้น',
              'Financial Checklist',
              'Web App',
              'LINE Community',
            ...
            <p className="disclaimer">
              ชำระครั้งเดียว • สิทธิ์หลักตามเงื่อนไขตลอดชีพ
            </p>
          </aside>
        </div>
      </main>
...
export default function Checkout() {
  return (
    <Suspense fallback={<div className="section">กำลังโหลด...</div>}>
      <CheckoutContent />
    </Suspense>
  )
}